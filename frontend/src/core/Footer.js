...
const Footer = () => {
  return (
    <footer className="px-3 py-8 bg-gray-900 w-full text-2 text-gray-300 transition-colors duration-200">
        ...
        <div className="mt-4 md:mt-0 flex flex-col md:flex-row">
          ...
          <div className="mt-7 md:mt-0 flex-1 flex flex-col items-center justify-center md:items-start md:pl-5">
            ...
            <span className="mt-7 md:mt-1">
              Created by
              <a
                className="underline hover:text-primary-gray-20 mx-1"
                href="https://www.linkedin.com/in/sumit-chaudhary-931120173/"
              >
                Sumit
              </a>
            </span>
